...
public class HorizontalExpCalendar extends RelativeLayout implements PageView.PageViewListener, Animations.AnimationsListener {
    ...
    /** 2019-04-11
     * OnClickDateTimeListner 추가 */
    private PageView.OnClickDateTimeListener onClickDateTimeListener;
        ...
        findViewById(R.id.scroll_to_today_button).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isLocked()) {
                    ...
                    scrollToDate(DateTime.now(), true, true, true);
                    unlock();
                }
            }
        });
    ...
    private void initBottomContainer() {
        ((ToggleButton) findViewById(R.id.tg_expand)).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
    ...
    private void refreshTitleTextView() {
        ...
        titleTextView.setText(String.format("%d년 %d월", titleDate.getYear(), titleDate.getMonthOfYear()));
    }
    ...
    public void onDayClick(DateTime dateTime) {
        ...
        if (onClickDateTimeListener != null) {
            onClickDateTimeListener.onClickDateTime(dateTime);
        }
    }
    ...
    public void setOnClickDateTimeListener(PageView.OnClickDateTimeListener onClickDateTimeListener) {
        this.onClickDateTimeListener = onClickDateTimeListener;
    }
}