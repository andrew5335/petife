...
public class Config {
   ...
   * UTC+9 적용
   * */
//  public static final DateTime INIT_DATE = new DateTime(DateTimeZone.forOffsetHours(9));
  public static final DateTime INIT_DATE = new DateTime(DateTimeZone.forOffsetHours(9));
  ...
  public static final int CELL_TEXT_CURRENT_MONTH_COLOR = Color.WHITE;
  public static final int CELL_TEXT_ANOTHER_MONTH_COLOR = Color.parseColor("#99000000");
