package kr.co.ainus.petife2.view.etc;
...
public abstract class ValueFormatter implements IAxisValueFormatter, IValueFormatter {
    ...
    /**
     * Used to draw navigation_menu labels, calls {@link #getFormattedValue(float)} by default.
     *
     * @param barEntry navigation_menu being labeled
     * @return formatted string label
     */
    ...
    /**
     * Used to draw stacked navigation_menu labels, calls {@link #getFormattedValue(float)} by default.
     *
