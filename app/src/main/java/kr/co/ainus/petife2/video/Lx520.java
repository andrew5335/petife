...
public class Lx520 {
    ...
    private Lx520.OnResultListener d;
    ...
    public Lx520(String var1, String var2) {
        this.a = var1;
        if (!var2.matches("")) {
            this.c = var2;
        }
    ...
    public void setOnResultListener(Lx520.OnResultListener var1) {
        this.d = var1;
    }

    public interface OnResultListener {
        void onResult(Lx520.Response var1);
    }

    class a extends AsyncTask<String, Void, Lx520.Response> {
        a() {
        }
        ...
        protected Lx520.Response a(String... var1) {
            String var2 = var1[0];
            int var3 = Integer.parseInt(var1[1]);
            Lx520.Response var4 = Lx520.this.new Response();
            var4.type = var3;
            ...
            try {
                ...
                String var10 = Base64.encodeToString((Lx520.this.b + ":" + Lx520.this.c).getBytes(), 2);
        ...
        protected void a(Lx520.Response var1) {
            Lx520.this.d.onResult(var1);
        }
    }
